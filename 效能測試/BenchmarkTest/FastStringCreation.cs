...
namespace 效能測試.BenchmarkTest {
  ...
  [MemoryDiagnoser]
  public class FastStringCreation : TestBase {
    private const string _testValue = "Password123!";
    /// <summary>
    /// 幼稚園方法
    /// <para>記憶體耗費 400 B</para>
    /// </summary>
    [Benchmark]
    [Arguments(_testValue)]
    ...
    public override void Run() {
      ...
      Console.WriteLine("輸入值 = " + _testValue);
      foreach (var method in methods) {
        Console.WriteLine($"方法 {method.Key.PadRight(30)} => {method.Value(_testValue)}");
      }
    }
  }
}
